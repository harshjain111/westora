...
// palette instead — #f5f0e8 surface, #ffffff surface-raised, #241d17 ink,
// #87642a accent, #717171 an ink-muted approximation.
export function NotificationEmail({
  ...
  return (
    <Html>
      ...
      <Body style={{ fontFamily: "Helvetica, Arial, sans-serif", backgroundColor: "#f5f0e8" }}>
        <Container style={{ backgroundColor: "#ffffff", padding: "32px", maxWidth: "560px" }}>
          ...
          <Link href={adminUrl} style={{ fontSize: "14px", color: "#87642a" }}>
            Open in admin →
          </Link>
        </Container>
      </Body>
